...
?>
<title>
    Board Members List | SFAC - Las Piñas
</title>
</head>
...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ">
        ...
        <h6 class="font-weight-bolder mb-0">View Board Members List</h6>
                ...
                <div class="col-12">
                    <div class="card shadow shadow-xl">
                        ...
                        <div class="card-header">
                            <h5 class="mb-0">Board Members List</h5>
                        ...
                        <div class="table-responsive px-4 my-4">
                            <table class="table table-flush table-hover responsive nowrap" style="width: 100%;"
                                ...
                                <tbody>
                                    <?php
                                    $listboard_membs = mysqli_query($db, "SELECT *, CONCAT(tbl_board_membs.board_membs_lastname, ', ', tbl_board_membs.board_membs_firstname, ' ', tbl_board_membs.board_membs_middlename) AS fullname FROM tbl_board_membs");
                                    while ($row = mysqli_fetch_array($listboard_membs)) {
                                        $id = $row['board_membs_id'];
                                    ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-sm font-weight-normal">
                                            <?php echo $row['board_membs_lastname']; ?></td>
                                        <td class="text-sm font-weight-normal">
                                            <?php echo $row['board_membs_firstname']; ?></td>
                                        <td class="text-sm font-weight-normal">
                                            <?php echo $row['board_membs_middlename']; ?></td>
                                        ...
                                        <td class="text-sm font-weight-normal">
                                            <a class="btn bg-gradient-primary text-xs"
                                                href="edit.board_membs.php?board_membs_id=<?php echo $id; ?>"><i
                                        ...
                                        <div class="modal-dialog modal-danger modal-dialog-centered modal-"
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <a href="userData/ctrl.del.board_membs.php?board_membs_id=<?php echo $id; ?>"
